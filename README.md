...
`@atleta-chainswap-router-contracts`
and import bytecode imported from artifacts located at
`@atleta-chainswap-router-contracts/artifacts/contracts/*/*.json`.
For example:
...
} from '@atleta-chainswap-router-contracts/artifacts/contracts/SwapRouter02.sol/SwapRouter02.json'
...
via the npm artifact `@atleta-chainswap-router-contracts`, e.g.:

```solidity
import '@atleta-chainswap-router-contracts/contracts/interfaces/ISwapRouter02.sol';
